import time
import math
from lib.local_utils import print_dbg
...
class DataSource():
    ...
    def __init__(self, name, resources, poll_freq=5, send_frame_ids='all', enabled=True) -> None:
        print_dbg("Initializing mock data source:")
        print_dbg("  Poll freq: {}".format(poll_freq))
        print_dbg("  Send frame ids: {}".format(send_frame_ids))
